...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    @IBOutlet weak var tbViewCountry: UITableView!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tbViewCountry.delegate = self
        self.tbViewCountry.dataSource = self
    }
